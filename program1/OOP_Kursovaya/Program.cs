...

{
    ...
    {
<<<<<<< HEAD
        Console.WriteLine("\nЧтобы изменить или просмотреть список животных введите число 1.\nчтобы изменить или просмотреть список сотрудников введите число 2.\nчтобы изменить стоимость билетов, список услуг или получить квитанцию введите число 3.\nЧтобы завершить работу введите любую другую цифру.");
=======
        Console.WriteLine("\nЧтобы изменить или просмотреть список животных введите 1.\nчтобы изменить или просмотреть список сотрудников введите 2.\nчтобы изменить стоимость билетов, список услуг или получить квитанцию введите 3.\nЧтобы завершить работу введите любую другую цифру.");
>>>>>>> br2
